...
import BasketConter from './BasketCounter';
    ...
    return (
        <>
            <Wrapper>
                ...
                <ChakraLink as={ReactRouterLink} to='/basket' borderRadius={'5px'} p={3} bg='yellow.200' fontSize={'2em'} textAlign={'center'}>Basket (<BasketConter />)</ChakraLink>
            </Wrapper>
        </>
    )
}