...
// The reason the orginal test is broken, is because it's asserting based on old test data
// We either need to control the test data, or find a more generic way to do the assert.

// Solution 1: More generalised assertion
test('Snacks added on the homepage should be displayed in the basket page', async ({ page }) => {
    ...
    // We could instead controll the inventory of snacks for the test.
    ...
    // Use regex to find te basket link, reguardless of how many items added.
